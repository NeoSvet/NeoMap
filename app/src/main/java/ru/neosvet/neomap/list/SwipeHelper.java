...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public static class UnderlayButton {
        ...
        public UnderlayButton(Bitmap image, int color, float radius, UnderlayButtonClickListener clickListener) {
            this.image = image;
            this.color = color;
            this.radius = radius;
        ...
        public void onDraw(Canvas c, RectF rect, int pos) {
            ...
            // Draw image
            if (image != null) {
                c.drawBitmap(image, rect.left + x - image.getWidth() / 2,
                        rect.top + y - image.getHeight() / 2, p);
            }
